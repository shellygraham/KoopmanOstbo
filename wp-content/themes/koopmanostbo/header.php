...
<head>
	...
	<script src="https://use.typekit.net/sfx8gsf.js"></script>
	<script>try{Typekit.load({ async: true });}catch(e){}</script>
	<script src="https://use.fontawesome.com/2b7f0e717b.js"></script>
...
<div id="page" class="hfeed site">
	<a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'some-like-it-neat' ); ?></a>
		...
		<?php tha_header_top(); ?>
			...
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="logo-anchor"><?php bloginfo( 'name' ); ?>	</a>
